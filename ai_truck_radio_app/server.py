    ...
    class Handler(BaseHTTPRequestHandler):
        ...
        def do_POST(self) -> None:
            ...
            if path == "/api/skip":
                ...
                self.send_json({"ok": True, "started": started, "starting": engine.is_starting(), "running": engine.is_running(), "cleaned": clean})
                        ...
                        if isinstance(hosts_data, list):
                            ...
                            for h in hosts_data:
                                ...
                                clean_hosts.append({
                                    ...
                                    "intro_enabled": bool(h.get("intro_enabled", True)),
                                    "regular_enabled": bool(h.get("regular_enabled", True)),
                                    "air_weight": max(0.01, float(h.get("air_weight", 1.0) or 1.0)),
                                    "aliases": aliases,
