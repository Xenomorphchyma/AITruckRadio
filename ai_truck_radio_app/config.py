...
DEFAULT_CONFIG: Dict[str, Any] = {
    "host": "127.0.0.1",
    "port": 8765,
    "station_name": "Волна FM",
    "station_genre": "Music / Talk",
    "station_language": "RU",
    "bitrate_kbps": 128,
    ...
    "dj_topic_mode": "auto",  # auto | music | news | weather | listener_story
    ...
    "station_id_fallback_texts": [
        "Волна FM. Хорошая музыка рядом.",
        "Волна FM — тёплый эфир и музыка для настроения.",
        "Оставайтесь на Волне FM."
    ],
    ...
    "available_styles": ["универсальное радио", "душевное радио", "уютное радио", "киберпанк", "хоррор-эфир"],
    ...
    "hosts": [
        {
            ...
            "qwen3_tts_speaker": "Ryan",
            "qwen3_tts_instruct": "Русский мужской FM-радиоведущий в прямом эфире. Уверенный баритон, энергичная тёплая подача, улыбка в голосе, яркие короткие акценты как на радио, темп бодрый, не аудиокнига, не спокойный диктор, не монотонно.",
            "f5_tts_ref_audio": "references/maxim_ref.wav",
            "f5_tts_ref_text": "",
            "omnivoice_ref_audio": "references/maxim_ref.wav",
            "omnivoice_ref_text": "",
            ...
            "qwen3_tts_instruct_variants": [
                "Русский мужской FM-радиоведущий в прямом эфире. Уверенный баритон, энергичная тёплая подача, улыбка в голосе, яркие короткие акценты как на радио, темп бодрый, не аудиокнига, не спокойный диктор, не монотонно.",
                "Мужской голос ночного FM: харизма ведущего, живые интонации, уверенная артикуляция, чуть быстрее обычной речи, рекламно-радиойная энергия без крика.",
                "Энергичный русский радиоведущий: бодрая подача, натуральные паузы, лёгкая ирония, эмоциональные акценты на названиях песен, ощущение живого эфира."
            ],
        },
        {
            "name": "Ирина",
            ...
            "qwen3_tts_instruct_variants": [
                ...
                "Женская русская соведущая душевного радио: светлый тембр, FM-энергия, лёгкий юмор, живые короткие акценты, чуть бодрее разговорного темпа, не робот и не аудиокнига.",
    ...
    "radio_persona": (
        "Ты пишешь текст для локального душевного музыкального радио. Оно звучит как самостоятельная радиостанция для обычного дня, без привязки к играм, симуляторам и ролевым сценам. "
        ...
        "Это обычное музыкальное радио для любой аудитории: дома, на работе, в браузере или просто на фоне. Запрещены игровые, транспортные и любые ролевые сцены; эфир не должен притворяться другой ситуацией, кроме настоящего радио. "
        "Основа эфира — музыка, слушатели, время, город, температура, погода и живое общение ведущих. Нужен душевный радиоэфир, а не ролевая сцена. "
    ...
    "fallback_host_phrases": [
        ...
        "Максим: Где бы ты ни слушал — дома, в браузере или просто на фоне дня — мы рядом.\nИрина: Следующий тре́к уже на подходе.",
    ],
}
