...
def style_prompt(style: str, night: bool) -> str:
    ...
    if "уют" in style_l:
        ...
        base = "киберпанк-радио: неон, синтетика, ночной город и музыка будущего, но без перегиба, машинной рутины и ролевой кабины"
    elif "хоррор" in style_l:
        base = "хоррор-эфир: загадочная атмосфера и лёгкое напряжение, но без трэша, без крика и без постоянной трассы"
    else:
        base = "универсальное локальное музыкальное радио: живые ведущие, музыка, настроение, слушатели, время, город и погода; не симулятор, не кабина, не рейс, не эфир для одних водителей"
    if "дальноб" in style_l:
        base += "; если в названии станции есть дорожная тема, считай это только названием бренда, а не поводом говорить про грузовики, кабины, рейсы и трассы"
    if night:
