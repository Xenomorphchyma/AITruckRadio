...
".venv_omnivoice\Scripts\python.exe" tools\omnivoice_render.py --mode clone --output cache\test_omnivoice_clone_maxim.wav --text-file docs\omnivoice_prompt_examples\clone_maxim_text.txt --instruct-file docs\omnivoice_prompt_examples\clone_maxim_instruct.txt --ref-audio references\maxim_ref.wav --ref-text-file references\maxim_ref.txt --device cuda:0 --steps 16 --speed 1.0
