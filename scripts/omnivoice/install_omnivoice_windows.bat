...
python -m pip install -U huggingface_hub hf_xet soundfile omnivoice
if errorlevel 1 (
  echo [WARN] PyPI omnivoice install failed. Trying GitHub source.
  python -m pip install -U huggingface_hub hf_xet soundfile git+https://github.com/k2-fsa/OmniVoice.git
)
python tools\omnivoice_probe.py
